...
define(function(require, exports, module) {
     ...
     *   Emits 'start', 'update', and 'end' events with Outputs an object with position, velocity, touch ids, and distance.
     *   Especially useful for getting distance between two fingers, as in a scale event.
     *   Deltas here represent increases or decreases in scale.
     ...
     * @param {Object} [options] default option overrides.  See TwoFingerSync.
     * @param {Number} [options.scale] scale outputs by a scalar.
     */
