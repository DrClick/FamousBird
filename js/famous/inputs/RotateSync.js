...
define(function(require, exports, module) {
    ...
    /**
     * Handles piped in two-finger touch events to support rotation.
     *   Outputs an object with position, velocity, touch ids, and angle.
     *   Emits 'start', 'update', and 'end' events with position, delta velocity, touch ids, and angle.
     *   Especially useful for getting angle since initial touch, as in a rotate event.
     *   Deltas here represent changes in angle.
     *   Can be used as delegate of GenericSync.
     *
     * @class RotateSync
     * @extends TwoFingerSync
     * @constructor
     * @param {function} legacyGetter position getter object
     * @param {Object} [options] default option overrides.  See TwoFingerSync.setOptions.
     */
